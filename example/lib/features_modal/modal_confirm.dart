              ...
              child: Row(
                children: <Widget>[
                  ...
                  TextButton(
                    ...
                    style: TextButton.styleFrom(backgroundColor: Theme.of(context).primaryColor,textStyle: TextStyle(color: Colors.white)),
            ...
            return Center(
              child: Padding(
                ...
                child: TextButton(
                  ...
                  style: TextButton.styleFrom(backgroundColor: Colors.redAccent,textStyle: TextStyle(color: Colors.white)),
